...
from PunyaChael import NSFW_LOG_CHANNEL, SPAM_LOG_CHANNEL, SUDOERS, PunyaChael
from PunyaChael.core import ikb
from PunyaChael.utils.db import downvote, ignore_nsfw, upvote, user_voted
from PunyaChael.utils.misc import clean, get_file_unique_id


@PunyaChael.on_callback_query(filters.regex(r"^upvote_"))
...
@PunyaChael.on_callback_query(filters.regex(r"^downvote_"))
