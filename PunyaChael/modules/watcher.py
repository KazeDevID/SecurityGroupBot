...
from PunyaChael.utils.db import (add_chat, add_user, chat_exists,
                          is_chat_blacklisted, is_nsfw_downvoted,
                          is_nsfw_enabled, is_spam_enabled,
                          is_user_blacklisted, update_spam_data,
                          user_exists)
from PunyaChael.utils.functions import (delete_nsfw_notify,
                                 delete_spam_notify, kick_user_notify)
from PunyaChael.utils.misc import admins, get_file_id, get_file_unique_id
...
async def message_watcher(_, message: Message):
    ...
    if message.chat.type in ["group", "supergroup"]:
        ...
        if is_chat_blacklisted(chat_id):
            await PunyaChael.leave_chat(chat_id)
